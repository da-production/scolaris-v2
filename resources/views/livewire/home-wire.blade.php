    ...
    <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
        <div>
            <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
                Postulez à votre future <span class="text-blue-600">formation</span></h1>
            <p class="mt-3 text-lg text-gray-800 dark:text-neutral-400">Déposez votre candidature aujourd’hui !</p>
            ...
            <div class="mt-7 grid gap-3 w-full sm:inline-flex">
                <a class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
                    wire:navigate href="{{ route('guest.candidat.inscription') }}">
                    Inscription
        ...
        <div class="relative ms-4">
            <img class="w-full rounded-md h-[600px] object-cover"
                src="{{ asset('images/personnes-diplomees-avec-des-diplomes-close-up.jpg') }}"
                alt="Hero Image">
            <div
