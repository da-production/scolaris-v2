<div
    ...
    <a wire:navigate href="{{ route('home') }}" class="flex items-center gap-4 text-[#111418]">
        ...
        <h2 class="bg-white px-3 py-0.5 rounded-lg shadow gap-2 text-[#111418] text-sm font-medium leading-normal flex  items-center">
    ...
    <div class="flex flex-1 justify-end gap-8">
        <div class="flex items-center gap-9">
            <a wire:navigate class="bg-white px-3 py-0.5 rounded-lg shadow text-[#111418] text-sm font-medium leading-normal flex items-center justify-center gap-2" href="{{ route('guest.candidat.connexion') }}">
